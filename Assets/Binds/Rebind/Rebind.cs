/*
 * An existing control binder.
 * 
 * Source:
 *   https://bitbucket.org/Bladesfist/rebind
 *
 * Usage:
 *   Place in "Binds\KeyBindings.txt":
 *      SELECT_POKE_PREV=PageUp,Comma,Minus,KeypadMinus
 *
 *   Check for input:
 *      Rebind.GetInputDown("THROW_POKEBALL")
 *      Rebind.GetInputUp("SPRINT")
 *      Rebind.GetInput("SELECT_POKE_PREV")
 */
